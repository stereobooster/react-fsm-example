...
declare module "react-router-dom" {
  ...
  //   key?: string
  // };
  // XXX: added for compatibility with history
  declare export type Location = BrowserLocation;
  ...
  declare export type RouterHistory = {
    ...
    block((location: Location, action: HistoryAction) => boolean): void,
    // XXX: added for compatibility with history
    block((location: Location, action: HistoryAction) => string): () => void;
    // createMemoryHistory
    index?: number,
